...
<form action="#" method="POST">
    ...
    <label>Prénom :</label><input type="text" name="per_prenom" value="<?php echo $per_a_modif->getPerPrenom(); ?>" required><br>
    <label>Téléphone :</label><input type="tel" name="per_tel" value="<?php echo $per_a_modif->getPerTel(); ?>" required><br>
    <label>Mail :</label><input type="email" name="per_mail" value="<?php echo $per_a_modif->getPerMail(); ?>" required><br>
    <label>Login :</label><input type="text" name="per_login" autocomplete="off" value="<?php echo $per_a_modif->getPerLogin(); ?>" required><br>
    <label>Mot de Passe :</label><input type="password" name="per_pwd" autocomplete="off" value="**********" required><br>
    ...
    <input type="radio" name="categorie" value="etudiant" <?php if ($statut=="etudiant"){echo "checked"; } ?>>Etudiant
    <input type="radio" name="categorie" value="personnel" <?php if ($statut=="salarie"){echo "checked"; } ?>>Personnel<br>
    <style type="text/css">
        .statut{
            display: none;
        }
    ...
    <div class="personnel statut">
        ...
        ?>
        <label>Téléphone professionnel :</label><input type="tel" name="sal_telprof" value="<?php echo $sal->getFonNum(); ?>"><br>
